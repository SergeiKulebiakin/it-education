              ...
              <button data-toggle="collapse" data-target="#navbarResponsive" className="navbar-toggler navbar-toggler-right text-uppercase bg-primary text-white rounded" aria-controls="navbarResponsive"
                  ...
                  <div className="collapse navbar-collapse" id="navbarResponsive">
                      <ul className="nav navbar-nav ml-auto">
                          ...
                          { this.props.userName &&
                            <li className="nav-item mx-0 mx-lg-1" role="presentation"><Link to="/profile"><a className="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger account-border">profile</a></Link></li>
                          }
                      </ul>
                  </div>
              </div>
